...
embed_use.add_field(name="`youtube`",
                    value="Let\'s you play music off of YouTube. Use it with `!youtube play LINK_TO_SONG`. You can also pause, resume, stop, change the volume (0-100) or make the bot leave the Voice Channel. Example: `!youtube pause`")
